 ...
 */
final class Version20240411075952 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE usuarios (id INT AUTO_INCREMENT NOT NULL, dni VARCHAR(9) NOT NULL, nombre VARCHAR(25) NOT NULL, apellidos VARCHAR(60) NOT NULL, ciudad VARCHAR(25) NOT NULL, estado TINYINT(1) NOT NULL, direccion VARCHAR(50) NOT NULL, fechaHora DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
